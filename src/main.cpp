			...
			if(carWin){
				ImGui::Begin("Car Selection");
					if(ImGui::CollapsingHeader("Audi")){
						...
						if(ImGui::Button("Load R8 LMS")){ model = LoadModel("models/r8_lms/scene.gltf");ClearBackground(BLACK);DrawText("Loading Model Data...", 0, 0, 50, WHITE);DrawText("The program may not respond during this process.", 0, 50, 15, WHITE);DrawText("Copyright © 2025 Benjamin Braun", config.copyrightX, config.copyrightY, 5, WHITE);context.modelScaleComb=10; }
						ImGui::Text("Credits:");
						...
						if(ImGui::Button("Load RS3")){ model = LoadModel("models/rs3/scene.gltf");ClearBackground(BLACK);DrawText("Loading Model Data...", 0, 0, 50, WHITE);DrawText("The program may not respond during this process.", 0, 50, 15, WHITE);DrawText("Copyright © 2025 Benjamin Braun", config.copyrightX, config.copyrightY, 5, WHITE);context.modelScaleComb=100; }
						ImGui::Text("Credits:");
					...
					if(ImGui::CollapsingHeader("Volkswagen")){
						...
						if(ImGui::Button("Load Golf 1992")){ model = LoadModel("models/1992_gti/scene.gltf");ClearBackground(BLACK);DrawText("Loading Model Data...", 0, 0, 50, WHITE);DrawText("The program may not respond during this process.", 0, 50, 15, WHITE);DrawText("Copyright © 2025 Benjamin Braun", config.copyrightX, config.copyrightY, 5, WHITE);context.modelScaleComb=100; }
						ImGui::Text("Credits:");
						...
						if(ImGui::Button("Load Golf 2014")){ model = LoadModel("models/2014_gti/scene.gltf");ClearBackground(BLACK);DrawText("Loading Model Data...", 0, 0, 50, WHITE);DrawText("The program may not respond during this process.", 0, 50, 15, WHITE);DrawText("Copyright © 2025 Benjamin Braun", config.copyrightX, config.copyrightY, 5, WHITE);context.modelScaleComb=100; }
						ImGui::Text("Credits:");
						...
						if(ImGui::Button("Load Jetta")){ model = LoadModel("models/jetta/scene.gltf");ClearBackground(BLACK);DrawText("Loading Model Data...", 0, 0, 50, WHITE);DrawText("The program may not respond during this process.", 0, 50, 15, WHITE);DrawText("Copyright © 2025 Benjamin Braun", config.copyrightX, config.copyrightY, 5, WHITE);context.modelScaleComb=1; }
						ImGui::Text("Credits:");
						...
						if(ImGui::Button("Load Polo WRC")){ model = LoadModel("models/polo_wrc/scene.gltf");ClearBackground(BLACK);DrawText("Loading Model Data...", 0, 0, 50, WHITE);DrawText("The program may not respond during this process.", 0, 50, 15, WHITE);DrawText("Copyright © 2025 Benjamin Braun", config.copyrightX, config.copyrightY, 5, WHITE);context.modelScaleComb=100; }
						ImGui::Text("Credits:");
